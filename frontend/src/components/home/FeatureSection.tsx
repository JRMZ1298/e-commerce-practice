        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {features.slice(0, 2).map((feature, index) => (
              <div
                key={feature.title}
                className={`rounded-2xl p-6 md:p-8 flex flex-col bg-cards boty-shadow transition-all duration-700 ease-out ${
              ...
              >
                ...
                <h3 className="text-[1.8rem] font-semibold text-foreground mb-2">
                  {feature.title}
                </h3>
            ...
            >
              <h3 className="text-[2rem] md:text-[2.4rem] font-bold mb-3">
                Estilo que habla por ti
              </h3>
              <p className="text-white/80 text-[1.4rem] leading-relaxed">
                Cada prenda cuenta una historia. Descubre piezas cuidadosamente
                seleccionadas para quienes valoran la autenticidad y la calidad.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-[1.6rem] text-muted-foreground leading-relaxed mb-10 max-w-md">
              Creemos que la moda debe ser una expresión de identidad, no solo
              una tendencia. Cada colección es cuidadosamente curada para
              ofrecerte lo mejor en estilo y calidad.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {features.slice(2).map((feature) => (
                <div
                  key={feature.title}
                  className="group p-5 boty-transition hover:scale-[1.02] rounded-md bg-cards boty-shadow"
                >
