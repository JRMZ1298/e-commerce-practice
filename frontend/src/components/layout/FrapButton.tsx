  ...
  return (
    <div ref={ref} className="fixed bottom-6 right-6 z-50">
        ...
        {visibleItems.map((item, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex items-center gap-3 rounded-full bg-background pr-5 pl-3 py-2.5 shadow-lg transition-all duration-200 group",
            ...
            >
              <span className="text-[1.3rem] font-medium text-brand-accent whitespace-nowrap group-hover:text-white transition-colors">
                {item.label}
              </span>
      ...
      <div className="relative h-20 w-20">
        <span
          className="absolute inset-0 rounded-full bg-brand-accent animate-pulse-ring pointer-events-none"
          style={{
            opacity: open ? 0 : 1,
        ...
        <button
          ...
          className="relative flex h-20 w-20 items-center justify-center rounded-full bg-brand-accent text-white shadow-lg transition-all duration-200 active:scale-95 hover:bg-brand-accent/90"
          style={{
            boxShadow: open
