                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="truncate text-[1.2rem] text-muted-foreground">
                        {user.email}
                      </p>
                    </div>
                    <span
                      className={cn(
                        "inline-flex rounded-full px-2.5 py-0.5 text-[1rem] font-medium",
                        statusCfg.color,
                      )}
                    >
                      {statusCfg.label}
                  ...
                  <div className="mt-3 flex items-center justify-between border-t border-border pt-3">
                    ...
                    {user.role !== "SUPER_ADMIN" && (
                      <button
                        ...
                        disabled={statusMutation.isPending}
                        className={cn(
                          "inline-flex items-center gap-1 rounded-full px-3 py-1 text-[1rem] font-medium transition-colors disabled:opacity-50",
                          user.status === "ACTIVE"
                            ? "bg-red-50 text-red-600 hover:bg-red-100"
                            : "bg-green-50 text-green-600 hover:bg-green-100",
                        )}
