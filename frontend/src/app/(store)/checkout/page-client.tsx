          ...
          {appliedCoupon ? (
            <div className="flex items-center justify-between rounded-xl bg-green-50 p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[1.3rem] text-green-700">
                  {appliedCoupon.code}
                </span>
              </div>
              <button
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="btn-outline flex-shrink-0 px-5 text-[1.3rem] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {couponPending ? (
...
function AddressForm({
  ...
  return (
    <form
      ...
      className="mb-6 space-y-4 rounded-xl bg-muted/30 p-4"
    >
      <div>
