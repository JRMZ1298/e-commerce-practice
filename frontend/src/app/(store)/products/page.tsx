...
import { Search, SlidersHorizontal, X, ChevronDown, Package, ShoppingBag } from 'lucide-react'
...
function CatalogPageContent() {
  ...
  useEffect(() => { setInStockInput(inStock === 'true') }, [inStock])
  ...
  const hasFilters = q || category || minPrice || maxPrice || brand || sort || inStock
    ...
    <div className={cn('space-y-5', isMobile ? '' : 'space-y-6')}>
      ...
      <div>
        ...
        <div className="relative">
          <select
            value={categoryInput}
            onChange={(e) => { setCategoryInput(e.target.value); handleFilterChange('category', e.target.value) }}
      ...
      <div>
        ...
        <input
          ...
          value={brandInput}
          onChange={(e) => { setBrandInput(e.target.value); handleFilterChange('brand', e.target.value) }}
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            placeholder="Mín"
            value={minPriceInput}
            onChange={(e) => { setMinPriceInput(e.target.value); handleFilterChange('minPrice', e.target.value) }}
            className="input-field w-full px-3 py-2.5 text-[1.4rem]"
            min="0"
          />
          ...
          <input
            ...
            placeholder="Máx"
            value={maxPriceInput}
            onChange={(e) => { setMaxPriceInput(e.target.value); handleFilterChange('maxPrice', e.target.value) }}
            className="input-field w-full px-3 py-2.5 text-[1.4rem]"
            min="0"
          />
        </div>
      ...
      <div>
        <label className="flex cursor-pointer items-center gap-3">
          <input
            ...
            onChange={(e) => { setInStockInput(e.target.checked); handleFilterChange('inStock', e.target.checked ? 'true' : '') }}
          ...
          <aside className="hidden w-64 shrink-0 sm:block">
            <div className="sticky top-24 space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-[1.6rem] font-semibold text-foreground">Filtros</h2>
                {hasFilters && (
                  <button
            ...
            <div className="fixed inset-0 z-50 sm:hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 max-h-[85vh] overflow-y-auto rounded-t-3xl bg-background p-6">
                <div className="mb-6 flex items-center justify-between">
                  <h2 className="text-[1.8rem] font-semibold text-foreground">Filtros</h2>
